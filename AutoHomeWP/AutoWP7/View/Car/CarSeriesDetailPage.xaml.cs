...
namespace AutoWP7.View.Car
{
    ...
    public partial class CarSeriesDetailPage : PhoneApplicationPage
    {
        ...
        public void CarSeriesQuoteLoadData()
        {
            ...
            string url = string.Format("{0}{2}/cars/seriessummary-a2-pm3-v1.6.2-s{1}-t0xffff-c0.html", App.appUrl, carSeriesId, App.versionStr);
            ...
            try
            {
                using (LocalDataContext ldc = new LocalDataContext())
                {
                    ...
                    else
                    {
                        ...
                        string url = string.Format("{0}{3}/dealer/pddealers-a2-pm1-v1.6.2-sp0-ss{1}-c{2}-sc0-p1-s20.html", App.appUrl, carSeriesId, cityId, App.versionStr);
        ...
        {
            return string.Format("{0}{6}/news/seriesnews-a2-pm3-v1.6.2-ss{1}-cs{2}-c{3}-p{4}-s{5}.html", App.appUrl, carSeriesId, curNewsType, curCityId, pageIndex, pageSize, App.versionStr);
        }
    }
}