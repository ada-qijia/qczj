...
namespace AutoWP7.View.Car
{
    ...
    public partial class CarSeriesQuotePage : PhoneApplicationPage
    {
        ...
        public void CarSeriesConfigLoadData()
        {
            ...
            string url = string.Format("{0}{2}/cars/speccompare-a2-pm3-v1.6.2-t1-s{1}.html", App.appUrl, carId, App.versionStr);
        ...
        public void DealerLoadData()
        {
            ...
            using (LocalDataContext ldc = new LocalDataContext())
            {
                ...
                string url = string.Format("{0}{4}/dealer/pddealers-a2-pm3-v1.6.2-sp{1}-ss{2}-c{3}-sc0-p1-s20.html", App.appUrl, carId, 0, cityId, App.versionStr);
