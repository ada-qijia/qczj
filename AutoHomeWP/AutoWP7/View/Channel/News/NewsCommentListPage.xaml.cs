...
namespace AutoWP7.View.Channel.News
{
    ...
    public partial class NewsCommentListPage : PhoneApplicationPage
    {
        ...
        private void CommentLoadData(int pageIndex, int pageSize)
        {
            ...
            if (pageType == 1)
            {
                url = string.Format("{0}{4}/news/comments-a2-pm3-v1.6.2-n{1}-o0-p{2}-s{3}.html", App.appUrl, newsid, pageIndex, pageSize, App.versionStr);
            }
            else if (pageType == 2)
            {
                url = string.Format("{0}{4}/news/shuokecomments-a2-pm1-v1.6.2-n{1}-o0-p{2}-s{3}.html", App.appUrl, newsid, pageIndex, pageSize, App.versionStr);
            }
            else if (pageType == 3)
            {
                //http://app.api.autohome.com.cn/wpv1.4/news/videocomments-a1-pm3-v1.6.2-vi23-o23-p1-s20.html
                url = string.Format("{0}{4}/news/videocomments-a2-pm3-v1.6.2-vi{1}-o0-p{2}-s{3}.html", App.appUrl, newsid, pageIndex, pageSize, App.versionStr);
            }
