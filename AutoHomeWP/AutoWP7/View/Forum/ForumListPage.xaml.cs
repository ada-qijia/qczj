    ...
    public partial class ForumListPage : PhoneApplicationPage
    {
        ...
        public void carSeriesAllForumLoadData()
        {
            ...
            else //网络加载
            {
                ...
                string url = string.Format("{0}{1}/club/clubsseries-a2-pm3-v1.6.2-st0.html", App.appUrl, App.versionStr);
        ...
        public void AreaForumLoadData()
        {
            ...
            else//网络加载
            {
                ...
                string url = string.Format("{0}{1}/club/clubsarea-a2-pm3-v1.6.2-st0.html", App.appUrl, App.versionStr);
        ...
        public void SubjectLoadData()
        {
            ...
            else //网络加载
            {
                ...
                string url = string.Format("{0}{1}/club/clubstheme-a2-pm3-v1.6.2-st0.html", App.appUrl, App.versionStr);
