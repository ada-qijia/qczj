...
namespace AutoWP7.View.Forum
{
    public partial class ShowBigImage : PhoneApplicationPage
    {
        ...
        public void InitDate()
        {
            ...
            {
                url = string.Format("{0}{3}/club/appdutu-a2-pm3-v1.5.0-t{1}-r0-h{2}.html", App.appUrl, Id, imgUrl, App.versionStr);
            }
            else if (useType == UseTypeEnum.News)
            {
                url = string.Format("{0}{3}/news/newsimgall-a1-pm1-v1.5.0-n{1}-h{2}.html", App.appUrl, Id, imgUrl, App.versionStr);
            }
